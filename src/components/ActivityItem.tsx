...
export const ActivityItem: React.FC<ActivityItemProps> = ({
  ...
  return (
    <div className="group flex items-start justify-between gap-4 border-b border-slate-200 p-4 transition-colors last:border-b-0 hover:bg-slate-50">
      {/* ESQUERDA */}
      ...
      <div className="flex shrink-0 items-start gap-3">
        <div className="w-32 text-right">
          ...
          <div className="mt-1 text-xs font-mono text-slate-500 whitespace-nowrap">
